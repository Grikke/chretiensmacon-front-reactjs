      ...
      >
        ...
        <div className="directory-content">
          <div className="directory-title">
            {directory?.annuaryPost?.avatar?.sourceUrl && <Image className="directory-image" src={directory?.annuaryPost?.avatar?.sourceUrl} alt={directory?.title} width={45} height={45}/>}
            {directory?.title}
          </div>
